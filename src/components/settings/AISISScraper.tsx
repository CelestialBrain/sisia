...
export default function AISISScraper() {
  ...
  const startScraping = async () => {
    ...
    if (!scrapeSchedules && !scrapeCurriculum && !scrapeGrades && 
        !scrapeMySchedule && !scrapeMyProgram && !scrapeMyGrades && 
        !scrapeHoldOrders && !scrapeAccountInfo) {
      toast({
  ...
  return (
    <div className="space-y-4">
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Testing Phase:</strong> This feature requires your AISIS credentials. 
          Credentials are encrypted and stored securely. Automated scraping may violate 
          AISIS Terms of Service. Use at your own risk.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select what data you want to scrape from AISIS
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={isServerSide}
              onCheckedChange={setIsServerSide}
            />
          </div>
          ...
          <div className="space-y-6">
            ...
            {(scrapeSchedules || scrapeMySchedule || scrapeMyProgram || scrapeMyGrades || scrapeGrades || scrapeHoldOrders || scrapeAccountInfo) && (
              <Alert>
                <AlertTriangle className="h-4 w-4" />
                <AlertDescription>
          ...
          <Button 
            ...
            disabled={isScrapingRunning || !hasCredentials}
            className="w-full"
          >
              ...
              <ScrollArea className="h-64 rounded-md border p-4">
                <div className="space-y-2">
                  {logs.map((log, i) => {
                    ...
                    return (
                      <div key={i} className={`text-xs ${isProgramLog ? 'ml-4 border-l-2 border-primary/30 pl-2' : ''}`}>
                ...
                >
                  <div className="space-y-1 flex-1">
                    ...
                    {job.courses_processed > 0 && (
                      <p className="text-xs text-muted-foreground">
                        {job.courses_processed} courses processed
                      </p>
                    )}
                  </div>
                  <div className="flex items-center gap-2">
                ...
                >
                  <div className="space-y-1 flex-1">
                    ...
                    <div className="flex items-center gap-3 text-xs text-muted-foreground">
                      ...
                      <span>•</span>
                      <span>Ver {program.version_year} Sem {program.version_sem}</span>
                      <span>•</span>
